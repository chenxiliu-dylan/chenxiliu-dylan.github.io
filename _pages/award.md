...
<ul style="list-style-type: none; padding-left: 0; margin-top: 1.5rem;">
  ...
  <li style="margin-bottom: 1.8rem; font-size: 0.95rem; line-height: 1.6; color: #333;">
    ...
    <strong>Fengze Yang</strong> received ITE Utah Section Student Scholarship and presented his recent research in the <a href="#">Mountain District ITE Conference</a>. Learn more from the <a href="#">LinkedIn Post</a>.
  </li>
