...
> 
> Learn more about this research: [**C. Liu** , H. Yang, M. Zhu, T. Vaa, and Y. Wang*. "Real-time Multi-task Environmental Perception System for Traffic Safety Empowered by Edge Artificial Intelligence", in IEEE Transaction on Intelligent Transportation Systems, 2023.](https://ieeexplore.ieee.org/abstract/document/10249217)
...
> 
> Learn more about this research: **C. Liu** , H. Yang, R. Ke, S. Yin, and Y. Wang*". Scale-Aware Representation Learning Empowered Sensing (SARLES) System for Pedestrian Crowds Perception in Complex Transportation Scenarios", accepted by Transportation Research Part C, in press.
...
> 
> Learn more about this research: H. Yang, **C. Liu** , J. Cai and J. Huang and Y. Wang*. "Mitigating the Bias of Deep Neural Network for Traffic Perception Empowered by Learning Few-Shot Representations." Submitted to IEEE Transactions on Intelligent Transportation Systems on July 2022, under review.
...
> 
> Learn more about this research: [**C. Liu** , H. Yang, Z. Cui, R. Ke, and Y. Wang*. "Cooperative and comprehensive multi-task surveillance sensing and interaction system empowered by edge artificial intelligence", Transportation Research Record, *2677* (9), 652-668. **Best Paper Award of TRB AED30 Committee**, 2023.](https://doi.org/10.1177/03611981231160174)
...
> 
> Learn more about this research: [H. Yang, J. Cai, **C. Liu**, R. Ke, and Y. Wang*. "Cooperative multi-camera vehicle tracking and traffic surveillance with edge artificial intelligence and representation learning. Transportation research part C: emerging technologies, 148, 103982, 2023.](https://doi.org/10.1016/j.trc.2022.103982)
